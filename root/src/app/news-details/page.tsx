              ...
              <div className="blog-post-details border-wrap">
                <div className="single-blog-post post-details">
                  <div className="post-content">
                    ...
                    <h2>Quality education through community learning hubs</h2>
                    ...
                    <p>
                      Edenwoods Eduhub Foundation partners with families and
                      schools to keep learners engaged through mentorship,
                      foundational literacy, and digital skills training.
                    </p>
                    <p>
                    ...
                    <Image
                      ...
                      alt="blog__img"
                    />
                    <h3>Learning gains through community support</h3>
                    <p>
                      Our mentors help learners build routines, confidence, and
                      academic resilience. With consistent guidance, students
                      begin to set goals and envision their next steps.
                    </p>
                    <blockquote>
                      Every child deserves a safe place to learn, grow, and
