      ...
      <div className="mega-menu-wrapper">
        <div className="header-main style-2">
          <div className="header-left">
            <div className="logo">
              <Logo />
              <Logo className="header-logo-2" logo="edenwoods-logo.svg" />
            </div>
          </div>
            ...
            items={[
              {
                ...
                content: "Hazaribagh, Jharkhand 825301",
              },
              {
                icon: "far fa-envelope",
                content: (
                  <a href="mailto:info@edenwoodseduhub.org" className="link">
              ...
              <ContactList
                items={[
                  ...
                  },
                  {
                    ...
                    content: <a href="tel:+919875600111">+91 98756 00111</a>,
                  },
                ]}
              />
          ...
          <div className="offcanvas__content">
            <div className="offcanvas__top mb-5 d-flex justify-content-between align-items-center">
              <div className="offcanvas__logo">
                <Logo logo="edenwoods-logo.svg" className="" />
              </div>
            ...
            <p className="text d-none d-xl-block">
              Edenwoods Eduhub Foundation empowers learners in Hazaribagh with
              community classrooms, digital labs, and scholarship pathways.
            </p>
            <MobileNav />
                ...
                {[
                  {
                    icon: "fal fa-map-marker-alt",
                    link: "#",
                    text: "Hazaribagh, Jharkhand 825301",
                  },
                  {
                    icon: "fal fa-envelope",
                    link: "mailto:info@edenwoodseduhub.org",
                    text: "info@edenwoodseduhub.org",
                  },
                  {
                    icon: "fal fa-clock",
                    link: "#",
                    text: "Mon-Sat, 09:00 AM - 06:00 PM",
                  },
                  {
                    icon: "far fa-phone",
                    link: "tel:+919875600111",
                    text: "+91 98756 00111",
                  },
                ].map((item, i) => (
                  <li key={i} className="d-flex align-items-center">
                    ...
                    <div className="offcanvas__contact-text">
                      ...
                      >
                        {i === 1 ? (
                          <span className="mailto:info@edenwoodseduhub.org">
                            {item.text}
                          </span>
                        ) : (
                          item.text
