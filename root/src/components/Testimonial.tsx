...
export const Testimonial1 = () => {
  const testimonials: {
  ...
  }[] = [
    {
      ...
      ratingTitle: "Learning Impact",
      rating: 5,
      text: "Edenwoods Eduhub helped my daughter regain confidence in school through after-school mentoring and digital classes.",
      clientImage: "/assets/img/testimonial/client.png",
      clientName: "Sunita Devi",
      clientRole: "Parent, Hazaribagh",
    },
    {
      quoteIcon: "/assets/img/testimonial/quote2.png",
      ratingTitle: "Community Trust",
      rating: 5,
      text: "Their scholarship guidance made it possible for me to apply to college and prepare for interviews.",
      clientImage: "/assets/img/testimonial/client2.png",
      clientName: "Rohit Kumar",
      clientRole: "Scholarship Recipient",
    },
    {
      quoteIcon: "/assets/img/testimonial/quote2.png",
      ratingTitle: "Learning Impact",
      rating: 5,
      text: "We partnered with Edenwoods to set up a community library, and attendance has grown every month.",
      clientImage: "/assets/img/testimonial/client.png",
      clientName: "Anita Singh",
      clientRole: "Community Partner",
    },
    {
      quoteIcon: "/assets/img/testimonial/quote2.png",
      ratingTitle: "Community Trust",
      rating: 5,
      text: "The digital lab has opened new opportunities for our students to explore STEM careers.",
      clientImage: "/assets/img/testimonial/client2.png",
      clientName: "Rakesh Prasad",
      clientRole: "Teacher, Hazaribagh",
    },
  ];
  return (
    <section
      ...
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2 className="mt-char-animation text-white" data-wow-delay=".3s">
            Stories of growth, confidence <br />
            and opportunity
          </h2>
        </div>
