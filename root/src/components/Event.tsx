...
export const Event1 = () => {
  const eventsData: {
  ...
  }[] = [
    {
      ...
      title: "Community Learning Day at Edenwoods",
      link: "event-details",
      description:
    ...
    },
    {
      ...
      time: "02:00 PM",
      location: "Hazaribagh, Jharkhand",
      title: "Parent Engagement & Learning Fair",
      link: "event-details",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do \n eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      delay: ".3s",
    },
    {
      ...
      time: "04:00 PM",
      location: "Hazaribagh, Jharkhand",
      title: "Scholarship Orientation & Career Talk",
      link: "event-details",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit sed do \n eiusmod tempor incididunt ut labore et dolore magna aliqua.",
      delay: ".5s",
    ...
    <section className="event-section-4 fix section-padding">
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2 className="mt-char-animation">Upcoming Learning Events</h2>
        </div>
      </div>
...
export const Event2 = () => {
  const eventsData: {
  ...
  }[] = [
    {
      ...
      time: "10:00 AM",
      location: "Hazaribagh, Jharkhand",
      title: "How to build a learning culture at home",
      description:
    ...
    },
    {
      ...
      time: "01:00 PM",
      location: "Hazaribagh, Jharkhand",
      title: "Community mentoring and career pathways",
      description:
        "Nullam faucibus eleifend mi eu varius. Integer vel tincidunt massa, quis semper odio. Mauris et mollis quam. Nullam fringilla erat id ante commodo sodales.",
      delay: ".5s",
    },
      ...
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2 className="mt-char-animation">
            Be ready for our upcoming <br /> education events
          </h2>
        </div>
        <div className="row">
...
export const EventPage = () => {
  const tabs: {
    ...
    { key: "water", label: "Literacy", delay: ".5s" },
    { key: "festival", label: "Workshops", delay: ".7s" },
    { key: "proevent", label: "Mentorship", delay: ".7s" },
    { key: "trending", label: "Community", delay: ".7s" },
  ];
    ...
    categories: [
      {
        ...
        title: "Project planning for community learning centers",
      },
      {
        image: "/assets/img/event/e2.jpg",
        title: "10 ways to support a learner at home",
      },
      {
        image: "/assets/img/event/e3.jpg",
        title: "Mobilizing neighborhood learning circles",
      },
      {
        image: "/assets/img/event/e4.jpg",
        title: "Upgrading classrooms with digital tools",
      },
      {
        image: "/assets/img/event/e5.jpg",
        title: "Leading youth clubs in rural communities",
      },
      {
        image: "/assets/img/event/e6.jpg",
        title: "Education outreach in Hazaribagh blocks",
      },
    ],
    water: [
      {
  ...
  const description =
    "Your support expands learning centers, digital labs, and scholarship guidance for students in Hazaribagh.";
