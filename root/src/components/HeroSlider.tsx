...
export const HeroSlider1 = () => {
  const slides: {
  ...
  }[] = [
    {
      ...
      mission: "Education • Digital Literacy • Mentorship",
      h1: "Learning Pathways \n For Every Child",
    ...
    },
    {
      ...
      mission: "Community Classrooms • Scholarships • Skills",
      h1: "Empowering Hazaribagh \n Through Education",
      video: "https://www.youtube.com/watch?v=Cn4G2lZ_g2I",
      delays: { h5: "1.3s", h1: "1.5s", buttons: "1.7s", video: "1.5s" },
    },
    {
      img: "assets/img/hero/hero-7.jpg",
      mission: "Teachers • Learners • Community Partners",
...
export const HeroSlider3 = () => {
  const slides: {
  ...
  }[] = [
    {
      ...
      mission: "Education, Skills, Opportunity",
      h1: "We’re Building Brighter Futures",
