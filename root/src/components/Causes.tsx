...
export const Causes1 = () => {
  const causesData: {
  ...
  }[] = [
    {
      ...
      title: "Launch new community learning center",
      description:
    ...
    },
    {
      ...
      title: "Scholarships for first-generation students",
      description:
    ...
    },
    {
      ...
      title: "Digital literacy labs in villages",
      description:
    ...
    },
    {
      ...
      title: "Career readiness for youth",
      description:
    ...
    <section className="causes-section fix section-bg section-padding">
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2 className="mt-char-animation">Our Key Programs</h2>
        </div>
        <div className="row">
                ...
                <div className="row g-4 align-items-center">
                  ...
                  <div className="col-lg-6">
                    <div className="content">
                      ...
                      >
                        <i className="far fa-heart" /> Support Education
                      </Link>
                    </div>
                  </div>
                </div>
