...
export const News1 = () => {
  const newsItems: {
  ...
  }[] = [
    {
      ...
      month: "Feb",
      category: "Learning",
      title: "Edenwoods Opens New Community Classroom",
      link: "news-details",
    ...
    },
    {
      ...
      title: "Teens Build Their First Coding Projects",
      link: "news-details",
      comments: "02 Comments",
      delay: ".5s",
      active: true,
    },
    {
      ...
      title: "Scholarship Success Stories from Hazaribagh",
      link: "news-details",
      comments: "02 Comments",
      delay: ".7s",
    },
    ...
    <section className="news-section fix section-padding pt-0">
      <div className="container">
        <div className="section-title text-center">
          ...
          <h2 className="mt-char-animation">Recent Updates</h2>
        </div>
        <div className="row">
...
export const News2 = () => {
  const newsData: {
  ...
  }[] = [
    {
      ...
      author: "Admin",
      category: "Education",
      title: "Why foundational literacy matters for rural learners",
      delay: ".3s",
    },
    {
      ...
      author: "Admin",
      category: "Community",
      title: "10 ways families can support learning at home",
      delay: ".5s",
    },
    {
      ...
      author: "Admin",
      category: "Skills",
      title: "Creating career pathways for first-generation students",
      delay: ".7s",
    },
  ];
  return (
...
export const News3 = () => {
  ...
  const mainNews: NewsItem = {
    date: "23",
    month: "June",
    title: "Why foundational literacy changes futures",
    author: "Edenwoods Team",
    tags: "Education, Literacy",
    description:
      "We highlight the learning milestones that help children build confidence, read fluently, and stay in school longer.",
  ...
  const sideNews: NewsItem[] = [
    {
      date: "23",
      month: "June",
      title: "Two sisters complete their first digital project",
      author: "Edenwoods Team",
      tags: "Digital Skills, Community",
      description:
        "Mentored lab sessions helped learners build their first presentations and explore STEM pathways.",
      delay: ".3s",
    },
    {
      date: "14",
      month: "Feb",
      title: "Volunteer mentors building confidence",
      author: "Edenwoods Team",
      tags: "Mentorship, Community",
      description:
        "Local professionals and college students guide learners through goal setting and career exploration.",
      delay: ".5s",
    },
    {
      date: "07",
      ...
      description:
        "We design safe learning spaces where every child feels welcome and supported.",
      delay: ".7s",
    },
  ];
